...
namespace DAN_LI_Dejan_Prodanovic.Validation
{
    class ValidationClass
    {
        ...
        public static bool IsAccountNumberValid(string accountNumber)
        {
           ...
           long temp;
           return long.TryParse(accountNumber,out temp);
        }

        public static bool IsInsuranceCardNumberValid(string insuranceCardNumber)
        {
            if (insuranceCardNumber.Length != 7)
            {
                return false;
            }
            long temp;
            return long.TryParse(insuranceCardNumber, out temp);
        }
    }
}
